...
export const findCountryByName = (value: string) => countries.find((country) => country.name === value);
export const findCountryByCode = (value: string) => countries.find((country) => country.code === value);
export const findCountryByAbbr = (value: string) => countries.find((country) => country.abbr === value);

const countries: Array<Country> = [
    { icon: 'ðŸ‡¸ðŸ‡ª', name: 'Sweden', abbr: 'SE', code: '46', tax_ids: ['eu_vat'] },
    { icon: 'ðŸ‡³ðŸ‡´', name: 'Norway', abbr: 'NO', code: '47', tax_ids: ['no_vat'] },
    { icon: 'ðŸ‡©ðŸ‡°', name: 'Denmark', abbr: 'DK', code: '45', tax_ids: ['eu_vat'] },
    { icon: 'ðŸ‡ºðŸ‡²', name: 'United States of America', abbr: 'US', code: '1', tax_ids: ['us_ein'] },
    { icon: 'ðŸ‡¬ðŸ‡§', name: 'United Kingdom', abbr: 'GB', code: '44', tax_ids: ['eu_vat'] },
    ...
    { icon: 'ðŸ‡¦ðŸ‡º', name: 'Australia', abbr: 'AU', code: '61', tax_ids: ['au_abn', 'au_abn'] },
    { icon: 'ðŸ‡¦ðŸ‡¹', name: 'Austria', abbr: 'AT', code: '43', tax_ids: ['eu_vat'] },
    ...
    { icon: 'ðŸ‡§ðŸ‡ª', name: 'Belgium', abbr: 'BE', code: '32', tax_ids: ['eu_vat'] },
    ...
    { icon: 'ðŸ‡§ðŸ‡·', name: 'Brazil', abbr: 'BR', code: '55', tax_ids: ['br_cnpj', 'br_cpf'] },
    {
        icon: 'ðŸ‡®ðŸ‡´',
    ...
    { icon: 'ðŸ‡§ðŸ‡¬', name: 'Bulgaria', abbr: 'BG', code: '359', tax_ids: ['eu_vat'] },
    ...
    { icon: 'ðŸ‡¨ðŸ‡¦', name: 'Canada', abbr: 'CA', code: '1', tax_ids: ['ca_bn', 'ca_gst_hst', 'ca_pst_bc', 'ca_pst_mb', 'ca_pst_sk', 'ca_qst'] },
    ...
    { icon: 'ðŸ‡¨ðŸ‡±', name: 'Chile', abbr: 'CL', code: '56', tax_ids: ['cl_tin'] },
    ...
    { icon: 'ðŸ‡­ðŸ‡·', name: 'Croatia', abbr: 'HR', code: '385', tax_ids: ['eu_vat'] },
    { icon: 'ðŸ‡¨ðŸ‡º', name: 'Cuba', abbr: 'CU', code: '53' },
    { icon: 'ðŸ‡¨ðŸ‡¼', name: 'Curacao', abbr: 'CW', code: '599' },
    { icon: 'ðŸ‡¨ðŸ‡¾', name: 'Cyprus', abbr: 'CY', code: '357', tax_ids: ['eu_vat'] },
    { icon: 'ðŸ‡¨ðŸ‡¿', name: 'Czech Republic', abbr: 'CZ', code: '420', tax_ids: ['eu_vat'] },
    ...
    { icon: 'ðŸ‡ªðŸ‡ª', name: 'Estonia', abbr: 'EE', code: '372', tax_ids: ['eu_vat'] },
    ...
    { icon: 'ðŸ‡«ðŸ‡®', name: 'Finland', abbr: 'FI', code: '358', tax_ids: ['eu_vat'] },
    { icon: 'ðŸ‡«ðŸ‡·', name: 'France', abbr: 'FR', code: '33', tax_ids: ['eu_vat'] },
    ...
    { icon: 'ðŸ‡¬ðŸ‡ª', name: 'Georgia', abbr: 'GE', code: '995', tax_ids: ['ge_vat'] },
    { icon: 'ðŸ‡©ðŸ‡ª', name: 'Germany', abbr: 'DE', code: '49', tax_ids: ['eu_vat'] },
    { icon: 'ðŸ‡¬ðŸ‡­', name: 'Ghana', abbr: 'GH', code: '233' },
    { icon: 'ðŸ‡¬ðŸ‡®', name: 'Gibraltar', abbr: 'GI', code: '350' },
    { icon: 'ðŸ‡¬ðŸ‡·', name: 'Greece', abbr: 'GR', code: '30', tax_ids: ['eu_vat'] },
    ...
    { icon: 'ðŸ‡­ðŸ‡²', name: 'Heard Island and McDonald Islands', abbr: 'HM', code: '672' },
    { icon: 'ðŸ‡»ðŸ‡¦', name: 'Holy See (Vatican City State)', abbr: 'VA', code: '379' },
    { icon: 'ðŸ‡­ðŸ‡³', name: 'Honduras', abbr: 'HN', code: '504' },
    { icon: 'ðŸ‡­ðŸ‡°', name: 'Hong Kong', abbr: 'HK', code: '852', tax_ids: ['hk_br'] },
    { icon: 'ðŸ‡­ðŸ‡º', name: 'Hungary', abbr: 'HU', code: '36', tax_ids: ['eu_vat'] },
    { icon: 'ðŸ‡®ðŸ‡¸', name: 'Iceland', abbr: 'IS', code: '354' },
    { icon: 'ðŸ‡®ðŸ‡³', name: 'India', abbr: 'IN', code: '91', tax_ids: ['in_gst'] },
    { icon: 'ðŸ‡®ðŸ‡©', name: 'Indonesia', abbr: 'ID', code: '62', tax_ids: ['id_npwp'] },
    { icon: 'ðŸ‡®ðŸ‡·', name: 'Iran, Islamic Republic of', abbr: 'IR', code: '98' },
    { icon: 'ðŸ‡®ðŸ‡¶', name: 'Iraq', abbr: 'IQ', code: '964' },
    { icon: 'ðŸ‡®ðŸ‡ª', name: 'Ireland', abbr: 'IE', code: '353', tax_ids: ['eu_vat'] },
    { icon: 'ðŸ‡®ðŸ‡²', name: 'Isle of Man', abbr: 'IM', code: '44' },
    { icon: 'ðŸ‡®ðŸ‡±', name: 'Israel', abbr: 'IL', code: '972', tax_ids: ['il_vat'] },
    { icon: 'ðŸ‡®ðŸ‡¹', name: 'Italy', abbr: 'IT', code: '39', tax_ids: ['eu_vat'] },
    { icon: 'ðŸ‡¯ðŸ‡²', name: 'Jamaica', abbr: 'JM', code: '1-876' },
    { icon: 'ðŸ‡¯ðŸ‡µ', name: 'Japan', abbr: 'JP', code: '81', tax_ids: ['jp_cn', 'jp_rn'] },
    ...
    { icon: 'ðŸ‡°ðŸ‡µ', name: "Korea, Democratic People's Republic of", abbr: 'KP', code: '850' },
    { icon: 'ðŸ‡°ðŸ‡·', name: 'Korea, Republic of', abbr: 'KR', code: '82', tax_ids: ['kr_brn'] },
    ...
    { icon: 'ðŸ‡±ðŸ‡¦', name: "Lao People's Democratic Republic", abbr: 'LA', code: '856' },
    { icon: 'ðŸ‡±ðŸ‡»', name: 'Latvia', abbr: 'LV', code: '371', tax_ids: ['eu_vat'] },
    ...
    { icon: 'ðŸ‡±ðŸ‡®', name: 'Liechtenstein', abbr: 'LI', code: '423', tax_ids: ['li_uid'] },
    { icon: 'ðŸ‡±ðŸ‡¹', name: 'Lithuania', abbr: 'LT', code: '370', tax_ids: ['eu_vat'] },
    { icon: 'ðŸ‡±ðŸ‡º', name: 'Luxembourg', abbr: 'LU', code: '352', tax_ids: ['eu_vat'] },
    { icon: 'ðŸ‡²ðŸ‡´', name: 'Macao', abbr: 'MO', code: '853' },
    { icon: 'ðŸ‡²ðŸ‡°', name: 'Macedonia, the Former Yugoslav Republic of', abbr: 'MK', code: '389' },
    { icon: 'ðŸ‡²ðŸ‡¬', name: 'Madagascar', abbr: 'MG', code: '261' },
    { icon: 'ðŸ‡²ðŸ‡¼', name: 'Malawi', abbr: 'MW', code: '265' },
    { icon: 'ðŸ‡²ðŸ‡¾', name: 'Malaysia', abbr: 'MY', code: '60', tax_ids: ['my_frp', 'my_itn', 'my_sst'] },
    { icon: 'ðŸ‡²ðŸ‡»', name: 'Maldives', abbr: 'MV', code: '960' },
    { icon: 'ðŸ‡²ðŸ‡±', name: 'Mali', abbr: 'ML', code: '223' },
    { icon: 'ðŸ‡²ðŸ‡¹', name: 'Malta', abbr: 'MT', code: '356', tax_ids: ['eu_vat'] },
    ...
    { icon: 'ðŸ‡²ðŸ‡½', name: 'Mexico', abbr: 'MX', code: '52', tax_ids: ['mx_rfc'] },
    { icon: 'ðŸ‡«ðŸ‡²', name: 'Micronesia, Federated States of', abbr: 'FM', code: '691' },
    ...
    { icon: 'ðŸ‡³ðŸ‡±', name: 'Netherlands', abbr: 'NL', code: '31', tax_ids: ['eu_vat'] },
    { icon: 'ðŸ‡³ðŸ‡¨', name: 'New Caledonia', abbr: 'NC', code: '687' },
    { icon: 'ðŸ‡³ðŸ‡¿', name: 'New Zealand', abbr: 'NZ', code: '64', tax_ids: ['nz_gst'] },
    ...
    { icon: 'ðŸ‡µðŸ‡±', name: 'Poland', abbr: 'PL', code: '48', tax_ids: ['eu_vat'] },
    { icon: 'ðŸ‡µðŸ‡¹', name: 'Portugal', abbr: 'PT', code: '351', tax_ids: ['eu_vat'] },
    ...
    { icon: 'ðŸ‡·ðŸ‡´', name: 'Romania', abbr: 'RO', code: '40', tax_ids: ['eu_vat'] },
    { icon: 'ðŸ‡·ðŸ‡º', name: 'Russian Federation', abbr: 'RU', code: '7', tax_ids: ['ru_inn', 'ru_kpp'] },
    ...
    { icon: 'ðŸ‡¸ðŸ‡¦', name: 'Saudi Arabia', abbr: 'SA', code: '966', tax_ids: ['sa_vat'] },
    ...
    { icon: 'ðŸ‡¸ðŸ‡¬', name: 'Singapore', abbr: 'SG', code: '65', tax_ids: ['sg_gst', 'sg_uen'] },
    { icon: 'ðŸ‡¸ðŸ‡½', name: 'Sint Maarten (Dutch part)', abbr: 'SX', code: '1-721' },
    { icon: 'ðŸ‡¸ðŸ‡°', name: 'Slovakia', abbr: 'SK', code: '421', tax_ids: ['eu_vat'] },
    { icon: 'ðŸ‡¸ðŸ‡®', name: 'Slovenia', abbr: 'SI', code: '386', tax_ids: ['eu_vat'] },
    { icon: 'ðŸ‡¸ðŸ‡§', name: 'Solomon Islands', abbr: 'SB', code: '677' },
    { icon: 'ðŸ‡¸ðŸ‡´', name: 'Somalia', abbr: 'SO', code: '252' },
    { icon: 'ðŸ‡¿ðŸ‡¦', name: 'South Africa', abbr: 'ZA', code: '27', tax_ids: ['za_vat'] },
    { icon: 'ðŸ‡¬ðŸ‡¸', name: 'South Georgia and the South Sandwich Islands', abbr: 'GS', code: '500' },
    { icon: 'ðŸ‡¸ðŸ‡¸', name: 'South Sudan', abbr: 'SS', code: '211' },
    { icon: 'ðŸ‡ªðŸ‡¸', name: 'Spain', abbr: 'ES', code: '34', tax_ids: ['es_cif', 'eu_vat'] },
    ...
    { icon: 'ðŸ‡¨ðŸ‡­', name: 'Switzerland', abbr: 'CH', code: '41', tax_ids: ['ch_vat'] },
    { icon: 'ðŸ‡¸ðŸ‡¾', name: 'Syrian Arab Republic', abbr: 'SY', code: '963' },
    { icon: 'ðŸ‡¹ðŸ‡¼', name: 'Taiwan, Province of China', abbr: 'TW', code: '886', tax_ids: ['tw_vat'] },
    { icon: 'ðŸ‡¹ðŸ‡¯', name: 'Tajikistan', abbr: 'TJ', code: '992' },
    { icon: 'ðŸ‡¹ðŸ‡­', name: 'Thailand', abbr: 'TH', code: '66', tax_ids: ['th_vat'] },
    ...
    { icon: 'ðŸ‡ºðŸ‡¦', name: 'Ukraine', abbr: 'UA', code: '380', tax_ids: ['ua_vat'] },
    { icon: 'ðŸ‡¦ðŸ‡ª', name: 'United Arab Emirates', abbr: 'AE', code: '971', tax_ids: ['ae_trn'] },
