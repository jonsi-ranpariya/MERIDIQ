...
function ProcedureIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      <defs>
        ...
        <clipPath id="a">
          <rect className="a" width={35} height={35} />
        </clipPath>
      </defs>
      <g className="b">
